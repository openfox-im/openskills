...
const at_bn254_fp_t at_bn254_const_b_mont[1] = {{{
...
const at_bn254_fp_t at_bn254_const_p_minus_one_mont[1] = {{{
...
const at_bn254_fp_t at_bn254_const_p_minus_one_half[1] = {{{
...
const at_uint256_t at_bn254_const_sqrt_exp[1] = {{{
  0x4f082305b61f3f51, 0x65e05aa45a1c72a3, 0x6e14116da0605617, 0x0c19139cb84c680a,
}}};

static inline int
at_bn254_fp_is_neg_nm( at_bn254_fp_t * x ) {
  return at_uint256_cmp( x, at_bn254_const_p_minus_one_half ) > 0;
}

static inline at_bn254_fp_t *
at_bn254_fp_frombytes_nm( at_bn254_fp_t * r,
                          uchar const     buf[32],
                          int             big_endian,
                          int *           is_inf,
                          int *           is_neg ) {
  ...
  /* Field element */
  if( AT_UNLIKELY( at_uint256_cmp( r, at_bn254_const_p ) >= 0 ) ) {
    return NULL;
  }
  return r;
}
...
static inline uchar *
at_bn254_fp_tobytes_nm( uchar           buf[32],
                        at_bn254_fp_t * a,
                        int             big_endian ) {
  if( AT_BIG_ENDIAN_LIKELY( big_endian ) ) {
    at_uint256_bswap( a, a );
  }
  at_memcpy( buf, a, 32 );
  return buf;
}
...
static inline int
at_bn254_fp_eq( at_bn254_fp_t const * r,
                at_bn254_fp_t const * a ) {
  return at_uint256_eq( r, a );
}

static inline at_bn254_fp_t *
at_bn254_fp_from_mont( at_bn254_fp_t * r,
                       at_bn254_fp_t const * a ) {
...
static inline at_bn254_fp_t *
at_bn254_fp_to_mont( at_bn254_fp_t * r,
                     at_bn254_fp_t const * a ) {
...
static inline at_bn254_fp_t *
at_bn254_fp_neg_nm( at_bn254_fp_t * r,
                    at_bn254_fp_t const * a ) {
  if( AT_UNLIKELY( at_bn254_fp_is_zero( a ) ) ) {
    return at_bn254_fp_set_zero( r );
  }
  /* compute p-a */
  for( ulong i=0, cy=0; i<4; i++ ) {
    ulong p = at_bn254_const_p->limbs[i];
    ulong b = a->limbs[i];
    b += cy;
    cy = (b < cy);
    cy += (p < b);
...
static inline at_bn254_fp_t *
at_bn254_fp_set( at_bn254_fp_t * r,
                 at_bn254_fp_t const * a ) {
  r->limbs[0] = a->limbs[0];
  r->limbs[1] = a->limbs[1];
  r->limbs[2] = a->limbs[2];
...
static inline at_bn254_fp_t *
at_bn254_fp_add( at_bn254_fp_t * r,
                 at_bn254_fp_t const * a,
                 at_bn254_fp_t const * b ) {
  fiat_bn254_add( r->limbs, a->limbs, b->limbs );
  return r;
}

static inline at_bn254_fp_t *
at_bn254_fp_sub( at_bn254_fp_t * r,
                 at_bn254_fp_t const * a,
                 at_bn254_fp_t const * b ) {
...
static inline at_bn254_fp_t *
at_bn254_fp_neg( at_bn254_fp_t * r,
                 at_bn254_fp_t const * a ) {
...
static inline at_bn254_fp_t *
at_bn254_fp_halve( at_bn254_fp_t * r,
                   at_bn254_fp_t const * a ) {
  int is_odd = a->limbs[0] & 0x1;
  at_uint256_add( r, a, is_odd ? at_bn254_const_p : at_bn254_const_zero );
...
AT_UINT256_FP_MUL_IMPL(at_bn254_fp, at_bn254_const_p, at_bn254_const_p_inv)

static inline at_bn254_fp_t *
at_bn254_fp_sqr( at_bn254_fp_t * r,
                 at_bn254_fp_t const * a ) {
  return at_bn254_fp_mul( r, a, a );
}

at_bn254_fp_t *
at_bn254_fp_pow( at_bn254_fp_t * restrict r,
                 at_bn254_fp_t const *    a,
                 at_uint256_t const *     b ) {
  at_bn254_fp_set_one( r );
...
static inline at_bn254_fp_t *
at_bn254_fp_inv( at_bn254_fp_t * r,
                  at_bn254_fp_t const * a ) {
  at_uint256_t p_minus_2[1];
  at_bn254_fp_set( p_minus_2, at_bn254_const_p );
  p_minus_2->limbs[0] = p_minus_2->limbs[0] - 2UL;
  return at_bn254_fp_pow( r, a, p_minus_2 );
}

static inline at_bn254_fp_t *
at_bn254_fp_sqrt( at_bn254_fp_t * r,
                  at_bn254_fp_t const * a ) {
  /* Alg. 2, https://eprint.iacr.org/2012/685 */

  at_bn254_fp_t a0[1], a1[1];

  at_bn254_fp_pow( a1, a, at_bn254_const_sqrt_exp );

  at_bn254_fp_sqr( a0, a1 );
  at_bn254_fp_mul( a0, a0, a );
  if( AT_UNLIKELY( at_bn254_fp_eq( a0, at_bn254_const_p_minus_one_mont ) ) ) {
    return NULL;
  }

  at_bn254_fp_mul( r, a1, a );
  return r;
}