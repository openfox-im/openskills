...
at_r2526x8_compress( at_r2526x8_t const * a ) {
  ...
  /* Full second pass of carry propagation to handle cascading overflows.
     This is needed when inputs have limbs near their max (e.g., after
     multiple _nr operations in the Montgomery ladder). */
  h = wwl_shru( c0, AT_R2526X8_BASE0 );
  c0 = wwl_and( c0, mask26 );
  c1 = wwl_add( c1, h );
  ...
  /* Final carry after second wrap-around */
  h = wwl_shru( c0, AT_R2526X8_BASE0 );
  c0 = wwl_and( c0, mask26 );
  c1 = wwl_add( c1, h );
