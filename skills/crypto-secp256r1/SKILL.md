...
license: MIT
metadata: { "openfox": { "requires": { "bins": ["node"] }, "provider-backends": { "sign": { "entry": "scripts/sign.mjs", "description": "Generate ECDSA signatures over P-256" }, "verify": { "entry": "scripts/verify.mjs", "description": "Verify ECDSA signatures over P-256" } } } }
---
